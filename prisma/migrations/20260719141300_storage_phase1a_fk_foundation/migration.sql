...
ALTER TABLE "knowledge_documents" ADD CONSTRAINT "knowledge_documents_storage_file_id_fkey"
  FOREIGN KEY ("storage_file_id") REFERENCES "files"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "users" ADD CONSTRAINT "users_avatar_file_id_fkey"
  FOREIGN KEY ("avatar_file_id") REFERENCES "files"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
