...
> = {
  ...
  'CABLE-002': {
    label: 'افت ولتاژ',
    labelEn: 'Voltage Drop',
    category: 'cable',
    standard: 'IEC 60364-5-52',
    pro: false,
  },
  'CABLE-003': {
    label: 'اتصال کوتاه کابل',
    labelEn: 'Short Circuit Cable',
    category: 'cable',
    standard: 'IEC 60949',
    pro: true,
  },
  ...
  'TRF-002': {
    label: 'تلفات ترانس',
    labelEn: 'Transformer Losses',
    category: 'transformer',
    standard: 'IEC 60076',
    pro: true,
  },
  'TRF-003': {
    label: 'تنظیم ولتاژ ترانس',
    labelEn: 'Voltage Regulation',
    category: 'transformer',
    standard: 'IEC 60076',
    pro: true,
  },
  'TRF-004': {
    label: 'K-Factor ترانس',
    labelEn: 'K-Factor',
    category: 'transformer',
  ...
  'PROT-004': {
    label: 'انتخاب فیوز',
    labelEn: 'Fuse Selection',
    category: 'protection',
    standard: 'IEC 60269',
    pro: false,
  },
  'PROT-001': {
    label: 'انتخاب MCCB/ACB',
    labelEn: 'MCCB/ACB Selection',
    category: 'protection',
    standard: 'IEC 60947-2',
    pro: true,
  },
  'SC-001': {
    label: 'اتصال کوتاه سیستم',
  ...
  'ARC-001': {
    label: 'انرژی وقوعی قوس',
    labelEn: 'Incident Energy',
    category: 'protection',
    standard: 'IEEE 1584-2018 / NFPA 70E',
    pro: true,
  },
  'PROT-003': {
    label: 'آنالیز سلکتیویته',
    labelEn: 'Selectivity Analysis',
    category: 'protection',
    standard: 'IEC 60947-2',
    pro: true,
  },
  'PROT-005': {
    label: 'هماهنگی حفاظتی (TCC)',
    labelEn: 'Protection Coord.',
    category: 'protection',
    standard: 'IEC 60255-151',
    pro: true,
  },
  'SWT-001': {
    label: 'کلید اصلی (اینکامر)',
    labelEn: 'Main Switch / Incomer',
    category: 'protection',
    standard: 'IEC 61439-1',
    pro: true,
  },
  'GND-001': {
    label: 'طراحی سیستم زمین',
    labelEn: 'Grounding Design',
    category: 'protection',
    standard: 'IEC 60364-5-54',
    pro: true,
  },
  'GND-002': {
    label: 'شبکه زمین پیشرفته',
    labelEn: 'Grounding Grid',
    category: 'protection',
  ...
  'CAP-001': {
    ...
    labelEn: 'Power Factor Correction',
  ...
  'PQ-004': {
    label: 'آنالیز رزونانس',
    labelEn: 'Resonance Analysis',
    category: 'power_quality',
    standard: 'IEC 61000',
    pro: true,
  },
  ...
  'PQ-006': {
    label: 'سایزینگ APF',
    labelEn: 'Active Filter (APF)',
    category: 'power_quality',
    standard: 'IEC 61000',
    pro: true,
  },
  'HARM-001': {
    label: 'هارمونیک پیشرفته',
    labelEn: 'Advanced Harmonic',
    category: 'power_quality',
    standard: 'IEC 61000-4-7 / IEEE 519',
    pro: true,
  },
  'PFC-001': {
    label: 'بانک خازنی',
  ...
  // ── انرژی تجدیدپذیر ─────────────────────────────────────────────────────
  'PV-001': {
    label: 'طراحی نیروگاه خورشیدی',
    labelEn: 'Solar PV Sizing',
    category: 'renewable',
    standard: 'IEC 62548',
    pro: false,
  },
  'MOT-001': {
    label: 'راه‌اندازی موتور',
    labelEn: 'Motor Starting',
    category: 'renewable',
    standard: 'IEC 60034',
    pro: false,
  },
  ...
  'BAT-BU-001': {
    label: 'زمان پشتیبانی باتری',
    labelEn: 'Battery Backup Time',
    category: 'renewable',
    standard: 'IEC 62169 / IEEE 1013',
    pro: true,
  },
  'BATTERY-002': {
    label: 'انتخاب شارژر باتری',
    labelEn: 'Battery Charger',
    category: 'renewable',
    standard: 'IEEE 485 / IEC 60364',
    pro: true,
  },
  'SOLAR-002': {
    label: 'سایزینگ اینورتر خورشیدی',
    labelEn: 'Inverter Sizing',
    category: 'renewable',
    standard: 'IEC 62548:2016',
    pro: true,
  },
  'SOLAR-003': {
    label: 'سایزینگ باتری خورشیدی',
    labelEn: 'Solar Battery Sizing',
    category: 'renewable',
  ...
  // ── آنالیز انرژی ────────────────────────────────────────────────────────
  'EA-001': {
    label: 'تحلیل مصرف انرژی',
    labelEn: 'Energy Analyzer',
    category: 'energy',
    standard: 'IEC 61000 / توانیر',
    pro: false,
  },
  // ── روشنایی ─────────────────────────────────────────────────────────────
  'LIGHT-001': {
    label: 'طراحی روشنایی داخلی',
    labelEn: 'Interior Lighting',
    category: 'lighting',
          ...
          <div className="flex flex-col items-center text-center gap-3 pt-1">
            ...
            <div>
              ...
              <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">
                ...
                <br />
                برای استفاده، پلن Pro را فعال کنید.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        <span className="text-[10px] text-[hsl(var(--muted-foreground))] font-mono mt-0.5">
          {code}
        </span>
      </div>
      ...
      <p
        className={cn(
          ...
          isLocked && 'text-[hsl(var(--foreground)/0.65)]',
        )}
      >
        {meta.label}
      </p>
...
export function EngineeringClient() {
  ...
  const filtered = Object.entries(CALC_META).filter(
        ...
        <div className="flex items-center gap-2.5 px-4 py-3 rounded-[var(--radius-lg)] border border-[hsl(var(--primary)/0.25)] bg-[hsl(var(--primary)/0.04)] text-sm">
          ...
          <span>
            ...
            <span className="text-[hsl(var(--muted-foreground))]">
              {' '}
              — تمام {freeCount + proCount} محاسبه برای شما فعال است
            </span>
          </span>
        </div>
      )}
