...
import { Zap, ChevronLeft, Calculator, Clock, AlertCircle } from 'lucide-react';
...
export function EngineeringClient() {
  ...
  const filtered = Object.entries(CALC_META)
    .filter(([code]) => {
      // اگر catalog لود شده، فقط codes موجود نمایش بده
      // اما محاسبات جدید (PV/MOT/BAT) همیشه نمایش داده می‌شوند
