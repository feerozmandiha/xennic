...
const FIELDS: Record<string, Field[]> = {
  ...
  'CABLE-001': [
    { key: 'load_current', label: 'جریان بار', unit: 'A', required: true },
    {
      ...
      type: 'select',
      options: [
        { value: 'B2', label: 'B2 (داخل لوله)' },
        { value: 'C', label: 'C (روی دیوار)' },
      ],
    },
  ...
  'CABLE-003': [
    {
      key: 'short_circuit_current_ka',
      label: 'جریان اتصال کوتاه',
      unit: 'kA',
      required: true,
      hint: 'مثال: 25',
    },
    {
      key: 'fault_duration_s',
      label: 'مدت خطا',
      unit: 's',
      required: true,
      hint: 'مثال: 0.1 تا 5',
  ...
  'CABLE-004': [
    {
      key: 'phase_conductor_size',
      label: 'سطح مقطع هادی فاز',
      unit: 'mm²',
      required: true,
      hint: 'مثال: 50',
    },
...
const DEFAULT_FIELDS: Record<string, Field[]> = {
  ...
  'TRF-002': [
    {
      key: 'no_load_loss_w',
      label: 'تلفات بی‌باری (هسته)',
      unit: 'W',
      required: true,
      hint: 'از کاتالوگ ترانس',
    },
    {
      key: 'load_loss_w',
      label: 'تلفات بارداری (مس)',
      unit: 'W',
      required: true,
      hint: 'از کاتالوگ ترانس',
    },
  ...
  'TRF-004': [
    {
      key: 'h1_current',
      label: 'جریان هارمونیک اصلی (ترد ۱)',
      unit: 'A',
      hint: 'درصد از جریان نامی',
    },
  ...
  'MOT-002': [
    ...
    {
      key: 'declared_efficiency_pct',
      label: 'راندمان نامی از روی پلاک',
      unit: '%',
      required: true,
      hint: 'از کاتالوگ موتور',
    },
    {
      key: 'pole_count',
      label: 'تعداد قطب',
  ...
  'PROT-002': [
    ...
    {
      key: 'bolted_fault_ka',
      label: 'جریان اتصال کوتاه (از SC-001)',
      unit: 'kA',
      required: true,
      hint: 'مثال: 25',
    },
    {
      key: 'arcing_fault_clearing_time_s',
      label: 'زمان قطع کلید حفاظتی',
      unit: 's',
      required: true,
      hint: 'مثال: 0.1',
    },
    {
      ...
      label: 'فاصله کار تا قوس',
      unit: 'mm',
      hint: 'LV≈450mm، MV≈900mm',
    },
  ...
  'PQ-002': [
    ...
    { key: 'h13_current', label: 'هارمونیک ۱۳', unit: 'A' },
    {
      key: 'max_demand_current_a',
      label: 'حداکثر جریان بار (IL)',
      unit: 'A',
      required: true,
      hint: 'میانگین پیک ۱۲ ماه',
    },
  ...
  'PQ-003': [
    ...
    {
      key: 'transformer_kva',
      label: 'توان ترانسفورماتور',
      unit: 'kVA',
      hint: 'برای توصیه درِیتینگ',
    },
  ],
  ...
  'PQ-004': [
    ...
    {
      key: 'present_harmonics',
      label: 'هارمونیک‌های موجود',
      type: 'text',
      hint: 'مثال: 5,7,11,13',
    },
  ],
  ...
  'PQ-005': [
    {
      key: 'target_harmonic_order',
      label: 'مرتبه هارمونیک هدف',
      required: true,
      hint: 'مثال: 5 برای هارمونیک ۵',
    },
  ...
  'GND-001': [
    {
      ...
      label: 'مقاومت ویژه خاک',
      unit: 'Ω·m',
      required: true,
      hint: 'رس≈50، لوم≈150، شن≈500',
    },
    {
      key: 'electrode_type',
      label: 'نوع الکترود',
    ...
    {
      key: 'max_resistance_ohm',
      label: 'حداکثر مقاومت مجاز',
      unit: 'Ω',
      hint: 'عمومی≤10Ω، حساس≤1Ω',
    },
  ...
  'SWT-001': [
    ...
    { key: 'transformer_kva', label: 'توان ترانسفورماتور', unit: 'kVA', hint: 'مثال: 630 یا 1000' },
    {
      ...
      label: 'ضریب همزمانی (Diversity)',
      unit: '(0-1)',
      hint: 'معمولاً 0.6-0.9',
    },
    {
      key: 'short_circuit_current_ka',
      label: 'جریان اتصال کوتاه نقطه',
      unit: 'kA',
      required: true,
      hint: 'از محاسبات SC',
    },
  ...
  'ECO-001': [
    ...
    },
    {
      ...
      label: 'هزینه‌های عملیاتی سالانه',
      unit: 'USD',
      hint: 'صفر پیش‌فرض',
    },
  ...
  'ECO-002': [
    ...
    {
      key: 'cash_flows',
      label: 'جریان‌های نقدی سالانه',
      unit: 'USD',
      required: true,
      hint: 'مثال: [3000,3000,3000,3000,3000]',
    },
  ...
  'SOLAR-002': [
    {
      key: 'pv_capacity_kwp',
      label: 'ظرفیت کل آرایه PV',
      unit: 'kWp',
      required: true,
      hint: 'مثال: 100',
    },
    {
      key: 'module_watt_peak',
      label: 'توان نامی پنل',
      unit: 'Wp',
      required: true,
      hint: '۴۵۰-۶۰۰',
    ...
    {
      key: 'module_temp_coeff_voc_pct',
      label: 'ضریب دمایی Voc',
      unit: '%/°C',
      hint: '۲۷/۰- پیش‌فرض',
    },
    ...
    {
      key: 'inverter_max_dc_voltage_v',
      label: 'حداکثر ولتاژ DC اینورتر',
      unit: 'V',
      hint: '۱۰۰۰/۱۵۰۰',
    },
    ...
    {
      key: 'inverter_max_input_current_a',
      label: 'حداکثر جریان ورودی DC',
      unit: 'A',
      hint: '۲۰۰ پیش‌فرض',
    },
    {
  ...
  'BAT-BU-001': [
    ...
    {
      key: 'individual_loads_kw',
      label: 'بارهای مجزا (JSON)',
      unit: 'kW',
      hint: 'مثال: [3,2,1.5]',
    },
  ],
  ...
  'SOLAR-003': [
    ...
    {
      key: 'pv_capacity_kwp',
      label: 'ظرفیت آرایه PV (اختیاری)',
      unit: 'kWp',
      hint: 'برای محاسبه کنترلر شارژ',
    },
    { key: 'peak_sun_hours', label: 'PSH (اختیاری)', unit: 'h/day', hint: '۵/۵ مثال' },
    {
      key: 'battery_cell_voltage_v',
      label: 'ولتاژ اسمی سلول',
      unit: 'V',
      hint: 'LiFePO4=3.2V, سرب-اسید=2V',
    },
    {
      key: 'battery_cell_capacity_ah',
      label: 'ظرفیت هر سلول (اختیاری)',
      unit: 'Ah',
      hint: '۲۰۰ مثال',
    },
    {
      key: 'max_charge_current_a',
      label: 'حداکثر جریان شارژ (اختیاری)',
      unit: 'A',
      hint: 'خالی = محاسبه خودکار',
    },
  ...
  'HARM-001': [
    ...
    { key: 'target_thd_percent', label: 'THD هدف', unit: '%', hint: 'معمولاً ۵%' },
    {
      ...
      label: 'طیف هارمونیک (JSON)',
      unit: '',
      required: true,
      hint: 'مثال: {"5":20,"7":14,"11":9,"13":6}',
    },
    {
      key: 'interharmonic_spectrum',
      label: 'طیف اینترهارمونیک (JSON)',
      unit: '',
      hint: 'مثال: {"175":5,"225":3}',
    },
    {
      key: 'filter_topology',
      label: 'توپولوژی فیلتر',
      type: 'select',
      options: [
    ...
    },
    {
      ...
      label: 'فرکانس سوییچینگ',
      unit: 'Hz',
      hint: '۱۰ کیلوهرتز پیش‌فرض',
    },
    ...
    {
      key: 'dc_bus_voltage_v',
      label: 'ولتاژ باس DC (اختیاری)',
      unit: 'V',
      hint: 'خالی = تخمین خودکار',
    },
  ],
  ...
  'PFC-001': [
    { key: 'active_power_kw', label: 'توان اکتیو بار', unit: 'kW', hint: 'مثال: ۲۰۰' },
    {
      ...
      label: 'توان ظاهری بار (جایگزین)',
      unit: 'kVA',
      hint: 'در صورت نداشتن توان اکتیو',
    },
    {
      key: 'power_factor_current',
    ...
    {
      key: 'short_circuit_mva',
      label: 'قدرت اتصال کوتاه (اختیاری)',
      unit: 'MVA',
      hint: 'برای محاسبه جریان هجومی',
    },
    ...
    {
      key: 'capacitor_cost_per_kvar',
      label: 'هزینه بانک خازنی',
      unit: 'USD/kVAr',
      hint: '۱۵ پیش‌فرض',
    },
  ],
  ...
  'GND-002': [
    ...
    {
      key: 'max_fault_current_a',
      label: 'حداکثر جریان خطای شبکه',
      unit: 'A',
      required: true,
      hint: 'از مطالعات SC',
    },
    ...
    {
      key: 'surface_resistivity_ohm_m',
      label: 'مقاومت لایه سطحی (سنگ‌ریزه)',
      unit: 'Ω·m',
      hint: 'سنگ‌ریزه≈3000',
    },
    { key: 'surface_thickness_m', label: 'ضخامت لایه سطحی', unit: 'm', hint: 'معمولاً 0.15m' },
    {
      key: 'current_division_factor',
      label: 'ضریب تقسیم جریان (Sf)',
      unit: '(0-1)',
      hint: 'معمولاً 0.6',
    },
    {
      key: 'body_weight',
      label: 'وزن بدن برای محاسبه',
      type: 'select',
      options: [
  ...
  'LIGHT-002': [
    ...
    {
      key: 'lamp_lumens',
      label: 'شار نوری هر چراغ',
      unit: 'lm',
      required: true,
      hint: 'LED خیابانی: 10000-25000',
    },
    {
      key: 'luminaire_power_w',
      label: 'توان هر چراغ',
      unit: 'W',
      required: true,
      hint: 'مثال: 150',
    ...
    {
      key: 'mounting_height_m',
      label: 'ارتفاع پایه (اختیاری)',
      unit: 'm',
      hint: 'پیش‌فرض: ۰.۸×عرض خیابان',
    },
    {
      key: 'arrangement_type',
      label: 'آرایش پایه‌ها (اختیاری)',
      type: 'select',
      options: [
    ...
    {
      key: 'target_spacing_m',
      label: 'فاصله پایه‌ها (اختیاری)',
      unit: 'm',
      hint: 'خالی=محاسبه خودکار',
    },
    {
    ...
    {
      key: 'light_loss_factor',
      label: 'ضریب افت نور (LLF)',
      unit: '(0-1)',
      hint: 'معمولاً 0.7-0.85',
    },
  ],
  ...
  'LIGHT-001': [
    ...
    {
      key: 'lamp_lumens',
      label: 'شار نوری هر لامپ',
      unit: 'lm',
      required: true,
      hint: 'مثال: 3500 (LED)',
    },
    {
      key: 'lamps_per_luminaire',
      label: 'تعداد لامپ در هر چراغ',
      unit: 'عدد',
      hint: 'معمولاً ۱-۴',
    },
    {
    ...
    },
    {
      ...
      label: 'ضریب انعکاس سقف',
      unit: '(0-1)',
      hint: 'سفید=0.7، تیره=0.3',
    },
    {
      key: 'reflectance_wall',
      label: 'ضریب انعکاس دیوار',
      unit: '(0-1)',
      hint: 'روشن=0.5، تیره=0.2',
    },
    { key: 'annual_operating_hours', label: 'ساعت کار سالانه', unit: 'h' },
  ],
  ...
  'PROT-004': [
    ...
    {
      key: 'motor_starting_current_a',
      label: 'جریان راه‌اندازی موتور',
      unit: 'A',
      hint: 'برای gM/aM',
    },
  ...
  'CAP-001': [
    ...
    {
      key: 'power_factor_target',
      label: 'ضریب قدرت هدف',
      unit: 'cos φ',
      hint: 'معمولاً 0.92-0.95',
    },
    { key: 'voltage_v', label: 'ولتاژ خط', unit: 'V' },
    {
      key: 'detuning_pct',
      label: 'درصد دیتونینگ (راکتور)',
      type: 'select',
      options: [
  ...
  return (
    <>
      {charts.map((chart: any, idx: number) => {
        ...
        if (chart.type === 'cable') {
          element = <CableChart key={idx} title={chart.title} bars={chart.bars ?? []} />;
        }
        return element ? (
          <div key={idx} data-chart-idx={idx}>
            {element}
          </div>
        ) : null;
      })}
...
function AiReviewDisplay({ ctx }: { ctx: AiReviewContext }) {
  ...
  return (
    <div
      ref={ctx.reviewRef}
      className="rounded-[var(--radius-lg)] border border-[hsl(var(--accent)/0.3)] bg-[hsl(var(--accent)/0.04)] p-4 animate-fade-in"
    >
      {/* Header */}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {v.standards.map((s: string, i: number) => (
                  <span
                    key={i}
                    className="inline-block rounded-md bg-[hsl(var(--accent)/0.08)] border border-[hsl(var(--accent)/0.15)] px-2 py-0.5 text-xs font-mono text-[hsl(var(--accent))]"
                  >
                    {s}
                  </span>
                ))}
            ...
            <div className="bg-[hsl(var(--warning)/0.06)] border border-[hsl(var(--warning)/0.15)] rounded-[var(--radius)] p-2.5">
              ...
              <ul className="space-y-1">
                {v.warnings.map((w: string, i: number) => (
                  <li
                    key={i}
                    className="text-xs text-[hsl(var(--warning)/0.8)] flex items-start gap-1.5"
                  >
            ...
            <div className="bg-[hsl(var(--accent)/0.06)] border border-[hsl(var(--accent)/0.15)] rounded-[var(--radius)] p-2.5">
              ...
              <ul className="space-y-1">
                {v.recommendations.map((r: string, i: number) => (
                  <li
                    key={i}
                    className="text-xs text-[hsl(var(--foreground))] flex items-start gap-1.5"
                  >
                    <span className="mt-0.5 shrink-0">•</span>
                    <span>{r}</span>
                  </li>
...
function ResultDisplay({
  ...
  return (
    <div className="mt-4 space-y-3 animate-fade-in">
          ...
          <dl className="space-y-2">
            {Object.entries(allResults).map(([key, val]) => {
              ...
              return (
                ...
                >
                  <dt className="text-xs text-[hsl(var(--muted-foreground))] font-mono">
                    {fieldLabels?.[key] ?? key}
                  </dt>
                  <dd
      ...
      {/* Suggested Products */}
      {suggestOpen && <SuggestedProducts code={code} result={result} />}
      ...
      if (code === 'ECO-002' || code === 'ECO-003') {
        if (inputs.cash_flows && typeof inputs.cash_flows === 'string') {
          try {
            ...
            inputs.cash_flows = String(inputs.cash_flows)
              .split(',')
              .map(Number)
              .filter((n: number) => !isNaN(n));
          }
