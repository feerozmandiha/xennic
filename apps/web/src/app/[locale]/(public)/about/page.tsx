...
const VALUES = [
  {
    icon: Shield,
    title: 'دقت و استاندارد',
    desc: 'تمام محاسبات بر اساس آخرین استانداردهای IEC و IEEE انجام می‌شود.',
  },
  {
    icon: Cpu,
    title: 'هوش مصنوعی مهندسی',
    desc: 'Xennic AI با مدل‌های تخصصی مهندسی برق، پاسخ‌های دقیق ارائه می‌دهد.',
  },
  {
    icon: Globe,
    title: 'دسترسی جهانی',
    desc: 'پلتفرم آنلاین با پشتیبانی از زبان فارسی و انگلیسی.',
  },
];
    ...
    <div className="min-h-screen bg-[hsl(var(--background))]">
      ...
      <div className="max-w-5xl mx-auto px-5 pt-32 pb-16 text-center">
        ...
        <p className="text-base sm:text-lg text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto leading-relaxed">
          Xennic یک پلتفرم یکپارچه برای محاسبات مهندسی برق، تحلیل کیفیت توان، انرژی‌های تجدیدپذیر و
          مشاوره تخصصی با استانداردهای بین‌المللی IEC و IEEE است.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-5 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {VALUES.map((v, i) => (
            <div
              key={i}
              className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))/0.02] hover:bg-[hsl(var(--secondary))/0.05] transition-colors"
            >
      ...
      {/* Team */}
      <div className="max-w-5xl mx-auto px-5 pb-20">
        <h2 className="text-2xl font-bold text-[hsl(var(--foreground))] text-center mb-8">
          تیم ما
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {TEAM.map((m, i) => (
            <div
              key={i}
              className="p-5 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))/0.02] text-center"
            >
