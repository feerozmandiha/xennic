...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default:     'bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] shadow hover:opacity-90 active:scale-[0.98]',
        destructive: 'bg-[hsl(var(--destructive))] text-white shadow hover:opacity-90',
        ...
        success:     'bg-[hsl(var(--success))] text-white shadow hover:opacity-90',
      },
      size: {
