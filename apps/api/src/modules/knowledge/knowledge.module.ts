...
import { KnowledgeFormulasController } from './presentation/controllers/knowledge-formulas.controller.js';
import { KnowledgeExamplesController } from './presentation/controllers/knowledge-examples.controller.js';
...
@Module({
  ...
  controllers: [
    ...
    KnowledgeFormulasController,
    KnowledgeExamplesController,
  ],
  providers: [
    KnowledgeService,
    {
