...
const OPENAI_MODELS = [
  { id: 'gpt-4o', name: 'GPT-4o', context: 128000, output: 16384, tools: true, json: true, vision: true, streaming: true, fc: true, structured: true, temp: true },
  { id: 'gpt-4o-mini', name: 'GPT-4o Mini', context: 128000, output: 16384, tools: true, json: true, vision: true, streaming: true, fc: true, structured: true, temp: true },
  { id: 'gpt-4-turbo', name: 'GPT-4 Turbo', context: 128000, output: 4096, tools: true, json: true, vision: true, streaming: true, fc: true, structured: true, temp: true },
  { id: 'gpt-4', name: 'GPT-4', context: 8192, output: 4096, tools: true, json: true, streaming: true, fc: true, temp: true },
  { id: 'gpt-3.5-turbo', name: 'GPT-3.5 Turbo', context: 16385, output: 4096, tools: true, json: true, streaming: true, fc: true, temp: true },
  { id: 'o1', name: 'O1', context: 200000, output: 100000, tools: false, json: false, vision: true, streaming: false, fc: false, reasoning: true, temp: false },
  { id: 'o1-mini', name: 'O1 Mini', context: 128000, output: 65536, tools: false, json: false, vision: true, streaming: false, fc: false, reasoning: true, temp: false },
  { id: 'o3-mini', name: 'O3 Mini', context: 200000, output: 100000, tools: true, json: true, vision: true, streaming: false, fc: true, reasoning: true, temp: true },
...
export class OpenAIDiscoveryStrategy implements IDiscoveryStrategy {
  ...
  private getStaticModels(): DiscoveryResult['models'] {
    return OPENAI_MODELS.map(m => ({
      modelId: m.id,
      displayName: m.name,
      modelType: m.embedding ? 'embedding' : m.image ? 'image' : m.transcription ? 'transcription' : m.audio ? 'audio' : m.reasoning ? 'reasoning' : 'chat',
