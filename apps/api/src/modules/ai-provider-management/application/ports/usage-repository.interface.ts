...
export interface IUsageRepository {
  ...
  findByProviderId(providerId: string, options?: { from?: Date; to?: Date }): Promise<ProviderUsageEntity[]>;
  findByPeriod(providerId: string, periodStart: Date, periodEnd: Date): Promise<ProviderUsageEntity | null>;
