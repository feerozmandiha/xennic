...
@Module({
  providers: [AIGatewayService, GatewayTelemetryService],
  exports: [AIGatewayService, GatewayTelemetryService],
})
export class AIGatewayModule {
  ...
  constructor() {
    this.logger.log(
      'AI Gateway Module initialized — all provider execution delegated to AiProviderManagement',
    );
  }
}
