...
export const STANDARD_REFERENCES: StandardReference[] = [
  ...
  {
    code: 'IEEE-399',
    title: 'IEEE Recommended Practice for Industrial and Commercial Power Systems Analysis',
    organization: 'IEEE',
  },
  {
    code: 'IEC-61439',
  ...
  {
    code: 'IEEE-446',
    title: 'IEEE Recommended Practice for Emergency and Standby Power Systems',
    organization: 'IEEE',
  },
];
