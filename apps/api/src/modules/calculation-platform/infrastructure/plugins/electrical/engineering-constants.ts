...
export const VOLTAGE_TOLERANCE_UTILITY = 0.1; // ±10%
...
export const PF_OFFICE = 0.9;
export const PF_INDUSTRIAL = 0.8;
export const PF_TARGET_TYPICAL = 0.95;
export const PF_MIN_UTILITY = 0.9;

// --- IEC 60909 Voltage Factors ---
export const IEC_C_MAX_HV = 1.1; // HV > 35kV
export const IEC_C_MAX_MV = 1.1; // MV 1-35kV
export const IEC_C_MAX_LV = 1.05; // LV < 1kV (tolerance +5%)
export const IEC_C_MIN_HV = 1.0;
export const IEC_C_MIN_MV = 1.0;
...
export const CABLE_GROUPING_RATING_FACTOR_TWO = 0.8;
export const CABLE_GROUPING_RATING_FACTOR_THREE = 0.7;
export const CABLE_GROUPING_RATING_FACTOR_FOUR = 0.65;
export const CABLE_GROUPING_RATING_FACTOR_FIVE = 0.6;
...
export const TRANSFORMER_PARALLEL_IMPEDANCE_TOLERANCE = 0.1; // 10%
