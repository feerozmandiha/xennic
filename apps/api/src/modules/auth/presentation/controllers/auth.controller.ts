...
export class AuthController {
  ...
  @ApiOperation({
    summary: 'Logout',
    description: 'Revokes all tokens and sessions for the current user.',
  })
  ...
  @ApiResponse({ status: 200, description: 'User profile retrieved', type: AuthUserResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  async getMe(@Req() req: any): Promise<{ success: boolean; data: AuthUserResponseDto }> {
